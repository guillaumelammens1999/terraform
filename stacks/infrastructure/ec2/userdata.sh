...
DB_HOST="database-bap-terraform.cocomvutku44.eu-central-1.rds.amazonaws.com"
DB_USER2="tester3"
...
define('WP_SITEURL', 'https://tf.bappende.link');\\
define('WP_HOME', 'https://tf.bappende.link');\\
